        ...
        <div className="flex flex-col text-cyan-900 dark:text-white w-full max-w-xl my-6 ">
            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-col mx-6 my-2" >
                    ...
                    <input className="p-2 w-60 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="street" required={true} minLength={2} placeholder="Street Name" size={10}/>
                </div>
                <div className="flex flex-col mx-6 my-2">
                    <label htmlFor="city">Mailing Address</label>
                    <input className="p-2 w-60 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="city" required={true} minLength={2} placeholder="Greenville" size={10}/>
                </div>
            </div>
            ...
            <div className="flex flex-row justify-between">
                ...
                <div className="flex flex-col mx-6 mb-2">
                    ...
                    <input className="p-2 w-40 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="city" required={true} minLength={2} placeholder="Color" size={10}/>
                </div>
                <div className="flex flex-col mr-6 mb-2">
                    <label htmlFor="city">Year</label>
                    <input className="p-2 w-20 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="city" required={true} minLength={2} placeholder="Year" size={10}/>
                </div>
            </div>
            <div className="flex flex-row justify-between">
                <div className="flex flex-col mx-6 mb-2">
                    <label htmlFor="address">Plate Number</label>
                    <input className="p-2 w-60 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="street" required={true} minLength={2} placeholder="Plate Name" size={10}/>
                </div>
                <div className="flex flex-col mx-6 mb-2">
                    <label htmlFor="address">State</label>
                    <select name="states" id="state-select" className="p-2 w-40 dark:bg-slate-800 mt-1 rounded-md">
                    <option value="">--</option>
            ...
            <h3 className="mx-6 mt-6 font-bold text-white mb-4">Window Stickers</h3>
            <div className="flex flex-row justify-between items-center">
                <div className="flex flex-col ml-6 mb-2">
                    <label htmlFor="address">Sticker Number</label>
                    <input className="p-2 w-30 dark:bg-slate-800 mt-1 rounded-md" type="text" id="street" name="street" required={true} minLength={2} placeholder="####" size={10}/>
                </div>
